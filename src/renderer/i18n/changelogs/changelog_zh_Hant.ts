const changelog = `
## v1.21.1 - 2026.06.12
1. 修復上傳檔案後發送按鈕無法恢復可用的問題
2. 更新 Android 應用圖示

## v1.21.0 - 2026.06.08
1. 新增 Vercel AI Gateway 模型提供方
2. 新增提供方 Spotlight，選擇模型提供方更快捷
3. 新增檔案對話能力，並優化大型檔案和多附件處理體驗
4. 新增 GPT Image 2 支援，並支援回報圖片生成中的有害內容
5. 新增 Microsoft 翻譯作為備用翻譯服務
6. 優化網路搜尋體驗，提升 BoCha、Tavily 和移動端 Bing 搜尋的穩定性
7. 優化錯誤資訊展示，支援更清晰的本地化錯誤提示、請求 ID 和重試狀態
8. 優化會話列表效能與穩定性，修復批量刪除、排序和遷移相關問題
9. 修復 Electron 升級後本地檔案路徑、資料庫目錄和附件處理相關問題
10. 修復網路錯誤後可能重複發起 AI 請求的問題
11. 修復知識庫、登入狀態、新手引導和設定介面的多項問題
12. 更新 Windows 應用圖示
