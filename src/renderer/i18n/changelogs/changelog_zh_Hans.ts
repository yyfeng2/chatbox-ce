const changelog = `
## v1.31.0 - 2026.09.12
1. MCP 升级至 2026-07-28 协议，远程服务器支持 OAuth 登录，设置页可实时查看工具列表
2. 推理强度调整为 low/high/max 三档，并移除 off 档
3. 新增通用截图功能，可截取任意屏幕区域到剪贴板
4. 修复多项内存泄露问题，优化内存占用

## v1.30.0 - 2026.08.26
1. 归档功能调整为直接删除对话，删除后不可恢复，请谨慎操作
2. 移除 Chatbox AI 官方服务依赖，模型提供方可完全自定义
3. 推理强度支持完整档位（none/minimal/low/medium/high/xhigh/max）
4. 禁用自动更新及后台定时检查
5. 多项稳定性优化与问题修复
